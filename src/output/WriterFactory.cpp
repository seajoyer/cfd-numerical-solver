...
auto WriterFactory::Create(const std::string& output_format, const std::string& output_dir) -> std::unique_ptr<StepWriter> {
    ...
    if (output_format == "vtk") {
         ...
         *
         * @note Assumes DataLayer provides cell-centered data (xc, xb) and primitive/conservative variables.
         */
