...
const xt::xtensor<double, 1>& BackwardEulerSpatialOperator::InvMetric(const Mesh& mesh,
...
void BackwardEulerSpatialOperator::ComputeRHS(DataLayer& layer,
                                              const Mesh& mesh,
                                              Workspace& workspace,
                                              const double gamma,
